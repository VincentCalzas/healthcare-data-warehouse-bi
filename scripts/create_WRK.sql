...
CREATE OR REPLACE TABLE R_ROOM (
...
CREATE OR REPLACE TABLE O_INDV (
    PART_ID INTEGER NOT NULL PRIMARY KEY,
...
CREATE OR REPLACE TABLE O_STFF (
...
CREATE OR REPLACE TABLE O_ADDR (
    PART_ID INTEGER,
...
CREATE OR REPLACE TABLE O_TELP (
    PART_ID INTEGER,
    STRT_VALD_DTTM TIMESTAMP(0),
    CNTR_IND VARCHAR(5),
...
CREATE OR REPLACE TABLE O_CONS (
...
CREATE OR REPLACE TABLE O_HOSP  (
...
CREATE OR REPLACE TABLE O_TRET (
