...
BEGIN
  ...
  SELECT    :ID_PERSONNEL_ARRAY[f.seq]::INTEGER,
    ...
    CASE 
      ...
      ELSE TO_TIMESTAMP(TO_DATE(REPLACE(:TS_CREATION_PERSONNEL_ARRAY[f.seq]::VARCHAR, '#', '0'), 'YYYY-MM-DD'))
    END AS TS_CREATION_PERSONNEL,
    CASE 
      WHEN :TS_MAJ_PERSONNEL_ARRAY[f.seq] IS NULL OR :TS_MAJ_PERSONNEL_ARRAY[f.seq] = ''  THEN TS_CREATION_PERSONNEL
