...
BEGIN
  ...
  INSERT INTO CHAMBRE
  SELECT 
    NO_CHAMBRE_ARRAY[i]::INTEGER,
    NOM_CHAMBRE_ARRAY[i]::VARCHAR,
    NO_ETAGE_ARRAY[i]::BYTEINT,
    NOM_BATIMENT_ARRAY[i]::VARCHAR,
    TYPE_CHAMBRE_ARRAY[i]::VARCHAR,
    PRIX_JOUR_ARRAY[i]::SMALLINT,
    DT_CREATION_ARRAY[i]::DATE
...
BEGIN
  ...
  SELECT 
    ...
    TS_CREATION_TRAITEMENT_ARRAY[f.seq]::TIMESTAMP
...
BEGIN
  ...
  SELECT 
    ...
    TS_DEBUT_ACTIVITE_ARRAY[f.seq]::TIMESTAMP,
    TS_FIN_ACTIVITE_ARRAY[f.seq]::TIMESTAMP,
    RAISON_FIN_ACTIVITE_ARRAY[f.seq]::VARCHAR,
    TS_CREATION_PERSONNEL_ARRAY[f.seq]::TIMESTAMP,
    TS_MAJ_PERSONNEL_ARRAY[f.seq]::TIMESTAMP,
...
BEGIN
  ...
  SELECT 
    ...
    TS_CREATION_PATIENT_ARRAY[f.seq]::TIMESTAMP,
    TS_MAJ_PATIENT_ARRAY[f.seq]::TIMESTAMP
...
BEGIN
  ...
  SELECT 
    ...
    ID_PERSONNEL_ARRAY[f.seq]::INTEGER,
    ID_PATIENT_ARRAY[f.seq]::INTEGER,
    TS_DEBUT_CONSULT_ARRAY[f.seq]::TIMESTAMP,
    TS_FIN_CONSULT_ARRAY[f.seq]::TIMESTAMP,
...
BEGIN
  ...
  SELECT 
    ...
    TS_DEBUT_HOSPI_ARRAY[f.seq]::TIMESTAMP,
    TS_FIN_HOSPI_ARRAY[f.seq]::TIMESTAMP,
    COUT_HOSPI_ARRAY[f.seq]::TIMESTAMP,
